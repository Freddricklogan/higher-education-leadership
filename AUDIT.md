# Conversion audit — higher-education-leadership
...
- Inline style attributes converted to classes: 52 occurrences, 23 distinct declarations.
...
- Buttons given an explicit type: 15; tables given a <tbody>: 3; <th> given a scope: 9; raw ampersands encoded: 1; top navigation given an accessible name.
- Sections with ids: 16 (landscape, explorer, governance, govdepth, frames, leadership, finance, enrollment, development, studentaffairs, dei, change, legal, assessment, accreditation, glossary).
